 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.sparrow.impl.RequireImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequireImpl extends MinimalEObjectImpl.Container implements Require
{
  ...
  {
    return SparrowPackage.Literals.REQUIRE;
  }
  ...
  public EList<String> getValue()
  {
    if (value == null)
    {
      value = new EDataTypeEList<String>(String.class, this, SparrowPackage.REQUIRE__VALUE);
    }
    return value;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SparrowPackage.REQUIRE__VALUE:
        return getValue();
    }
